    ...
    s.traverse((o) => {
      ...
      if (m.isMesh) {
        ...
        if (Array.isArray(m.material)) {
          m.material.forEach(
            (mat) => ((mat as any).shadowSide = THREE.FrontSide)
          );
        } else if (m.material) {
...
// Preload common models to avoid jank (ensure files exist)
...
useGLTF.preload("/assets/models/glb/special/chairModernCushion.glb");
useGLTF.preload("/assets/models/glb/special/chairRounded.glb");
useGLTF.preload("/assets/models/glb/special/tableCoffee.glb");
